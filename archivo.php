...
$consulta = "SELECT a.*, b.nombre_cat FROM productos a
                   ...
                   <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php echo $usuario['nombre_cat'];?></td>                             
                                <td><?php echo $usuario['clave_producto'];?></td>                                     
                                <td><?php echo $usuario['nombre'];?></td>
                                <td><?php echo $usuario['clasificacion'];?></td>                             
                                <td><?php echo $usuario['fam_quimica'];?></td>
                                <td><?php echo $usuario['uso'];?></td> 
                                <td><?php echo $usuario['des_general'];?></td>
                                <td><img src="<?php echo $usuario['img_principal'];?>" width="120"></td>   
                                <td> 

...
<section class="ContentPage full-width">
    ...
    <ul class="slides">
      <li>
        <img src="assets/img/slider_1.webp"> <!-- random image -->
        <div class="caption center-align card-panel indigo darken-4 ">
          <h4>Flottec Mexico</h4>
          <h5 class="light white-text text-lighten-3">Maximizando la flotacion mediante la tecnologia</h5>
        </div>
      </li> 
       <li>
        <img src="assets/img/slider_2.webp"> <!-- random image -->
        
      </li>     
       <li>
        <img src="assets/img/slider_3.webp"> <!-- random image -->
        <div class="caption left-align card-panel indigo darken-4" style="width: 150px; top: 60%; left: 0%;">
          <div class="has-text-weight-semibold">Equipo Flottec</div>
        </div>
      </li>  
      <li>
        <img src="assets/img/slider_6.webp"> <!-- random image -->
        <div class="caption right-align card-panel indigo darken-4" >
          <h4>Seminario Tecnico Flottec</h4>
          <h5 class="light white-text text-lighten-3">Zacatecas, Noviembre 2019</h5>
        </div>
      </li>
      <li>
        <img src="assets/img/slider_5.webp"> <!-- random image -->
        <div class="caption center-align card-panel indigo darken-4 "style="top: 0%;">
...
<script >
    ...
    var instances = M.Slider.init(elems, {
        indicators:false,height:670,duration: 800
    });
  });

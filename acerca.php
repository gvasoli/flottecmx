...
<title>Flottec - Acerca de Nosotros</title>
...
<nav>
    <div class="nav-wrapper light-blue darken-4">
        <div class="col s12">
            ...
            <a href="acerca.php" class="breadcrumb">Acerca de Nosotros</a>
        </div>
    </div>
  </nav>
</div>
...
<div class="row">
    ...
    <div class="columns">
        <div class="column" >
            ...
            <h4 class="has-text-weight-bold mt-0">¿Quiénes somos?</h4>
        </div>
            <div class="column">
                <p>Flottec es preponderantemente una empresa de tecnología, que de manera continua concentra sus esfuerzos en mejorar sus habilidades para proveer a la industria minera no solamente reactivos de calidad, sino que también provee servicio técnico especializado. Con nuestros productos innovadores, contribuimos a encontrar soluciones a algunos de los principales desafíos de nuestro tiempo y generar competencias clave en el beneficio de minerales por flotación ajustándonos a las necesidades de nuestros clientes.</p>
            </div>
        </div>
        <div class="column">
            <img src="assets/img/DSC_3644.webp">
        </div>
    </div>
</div>
</div>
<div class="row ">
<div class="section blue darken-4 z-depth-1">
    <div class="columns">
        <div class="column" >
            <div class="column white-text">
                <h4 class="has-text-weight-semibold">Misión</h4>
                <p>Generar un impacto positivo en la industria del procesamiento de minerales que se traduzca en ganancias medibles para nuestros clientes, empresa, empleados, socios y para la comunidad. Nuestra pasión por visión y valores, conducirá a que Flottec sea el proveedor preferentemente elegido para el suministro de reactivo.</p>
            </div>
        </div>
        <div class="column">
            <div class="column white-text">
                <h4 class="has-text-weight-semibold">Visión</h4>
                <p>Flottec es preponderantemente una empresa de tecnología, que de manera continua concentra sus esfuerzos en mejorar sus habilidades para proveer a la industria minera no solamente reactivos de calidad, sino que también provee servicio técnico especializado.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="section">
        <div class="columns">
            ...
            <h4 class="has-text-weight-bold">¿Donde nos ubicamos?</h4>
        
                <img src="assets/img/mapa5.webp">
            </div>
        </div>
    </div>
</div>

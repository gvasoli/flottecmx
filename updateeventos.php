...
$conexion = Bd::obtenerConexion();
    ...
    {   
        ...
        $titulo_evento = $_POST['utitulo_evento'];
        $fecha = $_POST['ufecha'];
        $lugar = $_POST['ulugar'];
        $descripcion = $_POST['udescripcion'];
        $ruta_img_principal = $_POST['uruta_img_principal'];
        $ruta_img_secundario = $_POST['uruta_img_secundario'];
        $contenido = $_POST['ucontenido'];

        $nombreArchivoConvert = strtr($titulo_evento, " ", "_");
        $str = strtolower("eventos/".$nombreArchivoConvert.".php");

        $select = "SELECT titulo_evento,archivo_html from eventos where evento_id='$id'";
...
$(document).ready(function () {
  ...
  $(document).ready(function(){
    $('.modal').modal();
        ...
        $query = "UPDATE eventos SET titulo_evento='$titulo_evento', fecha='$fecha', lugar='$lugar', descripcion=' $descripcion', ruta_img_principal='$ruta_img_principal', ruta_img_secundario='$ruta_img_secundario', archivo_html='$str' WHERE evento_id='$id'  ";
